...
function preencherSenha() {
  let value = document.getElementById("senha") as HTMLInputElement;
  password = value.value;
  validateLoginButton();
}

function preencherLogin() {
  let value = document.getElementById("login") as HTMLInputElement;
  username = value.value;
  validateLoginButton();
}

function preencherApi() {
  let value = document.getElementById("api-key") as HTMLInputElement;
  apiKey = value.value;
  validateLoginButton();
}
